...
plot_config = {
    # Re-enabled per request: modebar (autoscale/reset-axes/zoom buttons),
    # pinch-to-zoom on touch (scrollZoom), and double-click to reset/autoscale.
    # A floating fullscreen (⛶) button is also injected onto every chart —
    # see the guaranteed-inline script above — since Plotly.js has no
    # built-in fullscreen button of its own.
    'displayModeBar': True,
    'responsive': True,
    'scrollZoom': True,
...
with col1:
    ...
    # ---- Step 3: critical temperature/pressure block — finally, at the
    # end of Inputs. Its own unit pickers make Tc/Pc directly controllable
    # here (fmt_canon() below still keeps it in sync with unit dropdowns
    # used elsewhere on the page too). ----
