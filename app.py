...
# Fluid line too. Values now go through conv()/fmt_canon() like every other
# number in the app, so Tc/Pc actually update when the unit dropdowns change
# instead of always showing fixed °C / bar.
try:
